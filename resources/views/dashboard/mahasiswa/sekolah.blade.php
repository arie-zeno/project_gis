        ...
        <div class="card-body">
            @if ($biodata != null)
                @if ($biodata->sekolah != null)
                    <div class="row">
                        <div class="mb-2 d-flex justify-content-end">
                            <a href="{{route('mahasiswa.edit.sekolah', $biodata->nim)}}" class="btn btn-sm btn-outline-secondary"><i class="bi bi-pencil-square"></i> Edit</a>
                        </div>
                        <div class="col-sm-2">
                        ...
                        <div class="col-sm-4 d-flex flex-column justify-content-center">
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 300px">{{ Str::title($biodata->sekolah->provinsi) }}</td>
                                </tr>
                                <tr>
                                    <td class="fw-bold" style="width: 200px">Kota/Kabupaten</td>
                                    <td style="width: 300px">{{ Str::title($biodata->sekolah->kabupaten) }}</td>
                                </tr>
                                <tr>
                                    <td class="fw-bold" style="width: 200px">Kecamatan</td>
                                    <td style="width: 300px">{{ Str::title($biodata->sekolah->kecamatan) }}</td>
                                </tr>
                                <tr>
                                    <td class="fw-bold" style="width: 200px">Kelurahan</td>
                                    <td style="width: 300px">{{ Str::title($biodata->sekolah->kelurahan) }}</td>
                                </tr>
                ...
                @else
                    <div class="card border-0 shadow" style="background: #fff;">
                        <div class="card-body">
                            <h2>Anda belum mengisi riwayat pendidikan, <a href="{{ route('isi.sekolah') }}">isi riwayat
                                    pendidikan</a></h2>
                        </div>
                    </div>
                @endif
